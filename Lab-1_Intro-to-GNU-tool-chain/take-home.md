# _Free software is a social movement._
## _The four free_
_software freedoms have nothing to do with software
price. A software is free if it guarantees:
1. The freedom to run the program as you wish, for
any purpose (freedom o).
